...
class tx_twersatzteilservice_pi1 extends tslib_pibase
{
    ...
    function errorManagement()
    {
        ...
        } elseif ($all == "" && $modellname != "") //Kontrolle ob Suchbegriff als Bezeichnung eines Modells existiert
        {
            //Modellnamen suchen
            #Datens�tze holen
    ...
    function step3()
    {
        ...
        if ($res) {
            ...
            //BILD
            $markerArray['###PRODUKT_IMAGE###'] = $this->cObj->IMAGE([
