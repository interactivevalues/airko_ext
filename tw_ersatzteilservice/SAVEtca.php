	...
	'columns' => array (
		...
		'fid_ersatzteil' => array (		
			...
			'config' => array (
				...
				'type' => 'group',	
				'internal_type' => 'db',	
				'allowed' => 'tx_twersatzteilservice_produkt_ersatzteil',	
				'size' => 5,	
				'minitems' => 0,
				'maxitems' => 100,
			*/
...
$TCA['tx_twersatzteilservice_ersatzteil'] = array (
	...
	'interface' => array (
		'showRecordFieldList' => 'hidden,bezeichnung,bestellnummer,beschreibung,preis,einheit'
	),
	...
	'types' => array (
		'0' => array('showitem' => 'hidden;;1;;1-1-1, bezeichnung, bestellnummer, beschreibung, preis, einheit')
	),
	'palettes' => array (
		'1' => array('showitem' => '')
	)
...
$TCA['tx_twersatzteilservice_produkt_ersatzteil'] = array (
	...
	'interface' => array (
		'showRecordFieldList' => 'hidden,ersatzteilbezeichnung,posnummer,anzahl,gueltigbis'
	),
	...
	'columns' => array (
		...
		'ersatzteilbezeichnung' => array (		
			...
			'config' => array (
				...
				'foreign_table_where' => 'ORDER BY tx_twersatzteilservice_ersatzteil.uid',	
				'size' => 20,	
				'minitems' => 0,
				'maxitems' => 100,
			)
